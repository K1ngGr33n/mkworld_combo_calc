...
def runCalcs(listOfTimings, baseCombo: int, tFileName: str, rFileName: str, mode = 0, calcLog = False, timeLog = False):
    result = tC.calcLoop(listOfTimings, baseCombo, calcLog, timeLog)
